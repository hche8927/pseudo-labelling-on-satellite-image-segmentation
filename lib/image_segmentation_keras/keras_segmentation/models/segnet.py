...
def _segnet(n_classes, encoder,  input_height=416, input_width=608,
            input_channels=3, encoder_level=3):
...
def segnet(n_classes, input_height=416, input_width=608, input_channels=3, encoder_level=3):

    model = _segnet(n_classes, vanilla_encoder,  input_height=input_height,
                    input_width=input_width, input_channels=input_channels, encoder_level=encoder_level)
