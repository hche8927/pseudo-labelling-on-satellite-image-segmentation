...
def fcn_8(n_classes, encoder=vanilla_encoder, input_height=416,
          input_width=608, input_channels=3):
    ...
    o = Conv2DTranspose(n_classes, kernel_size=(16, 16), strides=(
        8, 8), padding='same', use_bias=False, data_format=IMAGE_ORDERING)(o)
...
def fcn_32(n_classes, encoder=vanilla_encoder,
           input_height=416, input_width=608, input_channels=3):
    ...
    o = (Conv2D(n_classes,  (1, 1), kernel_initializer='he_normal',
                data_format=IMAGE_ORDERING))(o)
    o = Conv2DTranspose(n_classes, kernel_size=(64, 64),padding='same',
...
def fcn_8_vgg(n_classes,  input_height=416, input_width=608, input_channels=3):
...
def fcn_32_vgg(n_classes,  input_height=416, input_width=608, input_channels=3):
...
def fcn_8_resnet50(n_classes,  input_height=416, input_width=608, input_channels=3):
...
def fcn_32_resnet50(n_classes,  input_height=416, input_width=608, input_channels=3):
