...
def _pspnet(n_classes, encoder,  input_height=384, input_width=576, input_channels=3):
...
def pspnet(n_classes, input_height=384, input_width=576, input_channels=3):
...
def resnet50_pspnet(n_classes,  input_height=384, input_width=576, input_channels=3):
